                    ...
                    />
                        ...
                        <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0">
                            ...
                            <div className="relative mb-4">
                                ...
                                onChange = {handleUserInput} className="w-full px-3 py-1 mt-2 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out border-gray-300 rounded outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200"  />
                            </div>
                            <div className="relative mb-4">
                                ...
                                placeholder="Enter your password" onChange = {handleUserInput} className="w-full px-3 py-1 mt-2 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out border-gray-300 rounded outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200"  />
                            </div>
                            <button type="submit" onClick = {handleFormSubmit}  className="w-full px-8 py-2 text-lg text-white bg-yellow-500 border-0 rounded focus:outline-none hover:bg-yellow-600 mt-5">Sign in</button>
                            <p className="mt-3 text-xs text-gray-500">Don't have have an account? 
                            <Link to="/auth/signup" className="text-yellow-500 ml-2">Sign up</Link>
                            </p>
                        </form>
                    </div>
                </section>
