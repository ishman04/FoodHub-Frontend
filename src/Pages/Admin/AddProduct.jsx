...
import Food from '../../Components/SVGs/Food.svg'
           ...
           <div className="flex items-center justify-center px-5">
                ...
                <div className="max-w-md md:w-4/6 mx-auto mt-8 bg-white p-4">
                    ...
                    <form>
                        ...
                        <button
                            type="submit"
                            className="w-full bg-yellow-500 text-white p-2 rounded-md hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50 transition duration-300 ease-in-out mt-5"
                        >
                            Add product
                        </button>
                    </form>
